var $=Object.defineProperty;var p=Object.getOwnPropertySymbols;var H=Object.prototype.hasOwnProperty,v=Object.prototype.propertyIsEnumerable;var x=(e,t,o)=>t in e?$(e,t,{enumerable:!0,configurable:!0,writable:!0,value:o}):e[t]=o,c=(e,t)=>{for(var o in t||(t={}))H.call(t,o)&&x(e,o,t[o]);if(p)for(var o of p(t))v.call(t,o)&&x(e,o,t[o]);return e};import{e as L,c as M,a as k,s as m,u as w,d as E,p as S,t as b}from"./index.69435fca.js";const C=c({transitionDuration:{prop:"--exio-slow-transition-duration",val:""}},S);function z(e,t={}){const o=L(e);M();const r=e.querySelector("summary"),h=k(r,{borderStyle:"reactive"}),n=m(r);n.innerHTML=`
    .${n.id} {
      cursor: default;
      user-select: none;
      position: relative;
  ...
  `;const g=e.querySelector("*:not(summary)"),i=m(e),s=m(r);let a;const l=y=>{a&&clearTimeout(a);const T=getComputedStyle(r),d=()=>b(T.getPropertyValue("--exio-slow-transition-duration")),u=()=>r.offsetHeight+g.offsetHeight;e.open?(y.preventDefault(),i.innerHTML=`
        .${i.id} {
          max-height: ${u()}px;
        }
...
//# sourceMappingURL=accordion.cf0447ee.js.map

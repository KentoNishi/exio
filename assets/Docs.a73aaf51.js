import{S as U,i as Z,s as W,E as oe,F as le,G as ue,H as ce,t as R,u as O,J as ke,K as ge,e as P,b as de,c as T,f as xe,g as V,h as L,j as N,k as Q,L as we,p as ee,q as ne,v as te,n as Ae}from"./vendor.087b2ff5.js";import{m as Fe,f as $e,j as Se}from"./index.bfb30096.js";import{e as _e}from"./accordion.0a3bd3ab.js";const pe=Symbol("src");function Ee(p){let l;const t=p[2].default,a=oe(t,p,p[1],null);return{c(){a&&a.c()},m(u,d){a&&a.m(u,d),l=!0},p(u,[d]){a&&a.p&&(!l||d&2)&&le(a,t,u,u[1],l?ce(t,u[1],d,null):ue(u[1]),null)},i(u){l||(R(a,u),l=!0)},o(u){O(a,u),l=!1},d(u){a&&a.d(u)}}}function Ce(p,l,t){let{$$slots:a={},$$scope:u}=l,{src:d=""}=l;return ke(pe,d),p.$$set=v=>{"src"in v&&t(0,d=v.src),"$$scope"in v&&t(1,u=v.$$scope)},[d,u,a]}class Pe extends U{constructor(l){super();Z(this,l,Ce,Ee,W,{src:0})}}var Te=`/**
...
${" ".repeat(v)}`,`
`).trim()};function Le(p){let l,t,a,u,d,v,o,b,S=J.highlight(p[0],J.languages.svelte,"svelte")+"",F,E,C;const M=p[3].default,x=oe(M,p,p[2],null);return{c(){l=P("div"),t=P("div"),x&&x.c(),a=de(),u=P("details"),d=P("summary"),d.textContent="View Source",v=de(),o=P("div"),b=P("pre"),T(t,"class","example-content"),T(d,"class","cyan"),T(b,"class","language-svelte svelte-1t426h1"),T(o,"class","example-src"),xe(u,"width","100%"),T(u,"class","svelte-1t426h1"),T(l,"class","example svelte-1t426h1")},m(f,h){V(f,l,h),L(l,t),x&&x.m(t,null),L(l,a),L(l,u),L(u,d),L(u,v),L(u,o),L(o,b),b.innerHTML=S,F=!0,E||(C=N(_e.call(null,u)),E=!0)},p(f,[h]){x&&x.p&&(!F||h&4)&&le(x,M,f,f[2],F?ce(M,f[2],h,null):ue(f[2]),null),(!F||h&1)&&S!==(S=J.highlight(f[0],J.languages.svelte,"svelte")+"")&&(b.innerHTML=S)},i(f){F||(R(x,f),F=!0)},o(f){O(x,f),F=!1},d(f){f&&Q(l),x&&x.d(f),E=!1,C()}}}const Me=()=>{const p=document.head.querySelector(".prism-styles");if(p!==null)return p;const l=document.createElement("style");return l.className="prism-styles",document.head.appendChild(l),l},Ie=Me();Fe.subscribe(p=>{Ie.innerHTML=p?je:Te});function De(p,l,t){let a,{$$slots:u={},$$scope:d}=l,{name:v=""}=l;const o=we(pe);return p.$$set=b=>{"name"in b&&t(1,v=b.name),"$$scope"in b&&t(2,d=b.$$scope)},p.$$.update=()=>{p.$$.dirty&2&&t(0,a=ze(o,v)),p.$$.dirty&1&&console.log(a)},[a,v,d,u]}class Re extends U{constructor(l){super();Z(this,l,De,Le,W,{name:1})}}var Oe=`<script lang="ts">
...
`;function Be(p){let l,t,a;return{c(){l=P("button"),l.textContent="Default Button",T(l,"class","gray")},m(u,d){V(u,l,d),t||(a=N($e.call(null,l)),t=!0)},d(u){u&&Q(l),t=!1,a()}}}function He(p){let l,t;return l=new Re({props:{name:"various-buttons",$$slots:{default:[Be]},$$scope:{ctx:p}}}),{c(){ee(l.$$.fragment)},m(a,u){ne(l,a,u),t=!0},p(a,u){const d={};u&1&&(d.$$scope={dirty:u,ctx:a}),l.$set(d)},i(a){t||(R(l.$$.fragment,a),t=!0)},o(a){O(l.$$.fragment,a),t=!1},d(a){te(l,a)}}}function qe(p){let l,t;return l=new Pe({props:{src:Oe,$$slots:{default:[He]},$$scope:{ctx:p}}}),{c(){ee(l.$$.fragment)},m(a,u){ne(l,a,u),t=!0},p(a,[u]){const d={};u&1&&(d.$$scope={dirty:u,ctx:a}),l.$set(d)},i(a){t||(R(l.$$.fragment,a),t=!0)},o(a){O(l.$$.fragment,a),t=!1},d(a){te(l,a)}}}class Ge extends U{constructor(l){super();Z(this,l,null,qe,W,{})}}function Ue(p){let l,t,a,u,d,v;return a=new Ge({}),{c(){l=P("div"),t=P("div"),ee(a.$$.fragment),T(t,"class","wrapper svelte-1x71mx5"),T(l,"class","center svelte-1x71mx5")},m(o,b){V(o,l,b),L(l,t),ne(a,t,null),u=!0,d||(v=N(Se.call(null,t)),d=!0)},p:Ae,i(o){u||(R(a.$$.fragment,o),u=!0)},o(o){O(a.$$.fragment,o),u=!1},d(o){o&&Q(l),te(a),d=!1,v()}}}class Xe extends U{constructor(l){super();Z(this,l,null,Ue,W,{})}}export{Xe as default};
//# sourceMappingURL=Docs.a73aaf51.js.map

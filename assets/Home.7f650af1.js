import{S as Yt,i as Kt,s as Gt,e as i,b as u,z as P,c as o,f as s,g as ve,h as e,j as p,l as Ne,k as fe,r as it,A as at,B as rl,n as Ae,m as ut,o as sl,C as cl,p as dl,q as ul,D as Re,t as pl,u as vl,v as fl,X as bl}from"./vendor.f5c7ec00.js";import{e as xe,a as ge,s as V,d as _e,c as Jt,t as hl,i as pt,b as qe,f as be,g as rt,h as Qt,j as vt,k as ml,l as Ut,m as el,n as tl}from"./index.f79a66f5.js";function We(t){const l=xe(t),n=ge(t,{borderStyle:"hover",disableClicking:!0}),a=V(t);return a.innerHTML=`
    .${a.id} {
      display: flex;
      align-items: center;
  ...
  `,_e(()=>{n.destroy(),a.remove(),r.remove(),l.destroy()})};function bt(t){const l=xe(t),n=ge(t,{disableClicking:!0,borderStyle:"hover",focusable:!0}),a=V(t);return a.innerHTML=`
    .${a.id} {
  ...
  `;const d=t.querySelector("*:not(summary)"),f=V(t),b=V(n);let x;const T=y=>{x&&clearTimeout(x);const H=getComputedStyle(n),k=()=>hl(H.getPropertyValue("--exio-slow-transition-duration")),w=n.offsetHeight+d.offsetHeight;t.open?(y.preventDefault(),f.innerHTML=`
        .${f.id} {
          max-height: ${w}px;
        }
      ...
      `,x=setTimeout(()=>{t.open=!1},k())},0)):(f.innerHTML=`
        .${f.id} {
          max-height: ${n.offsetHeight}px;
        }
      `,b.innerHTML=`
      ...
      `,setTimeout(()=>{f.innerHTML=`
        ...
        `,x=setTimeout(()=>{f.innerHTML=""},k())},0))};return n.addEventListener("click",T),_e(()=>{a.destroy(),r.remove(),v.remove(),f.remove(),l.destroy(),n.removeEventListener("click",T)})}function ht(t){const l=xe(t),n=V(t),a=`

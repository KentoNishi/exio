import{s as _,f as Rt,g as Y,h as ae,t as Nt,i as Qe,j as Te,a as te,e as Ue,k as At,c as It,l as qt,b as Wt,m as Bt}from"./index.fbb488eb.js";import{A as Yt,S as Zt,i as Xt,s as Gt,e as i,a as u,u as se,b as l,v as a,c as oe,f as o,g as p,l as ye,h as le,r as et,z as tt,B as Jt,n as Me,j as Kt,C as Qt}from"./vendor.78a60faf.js";function vo(t){const e=_(t),n=Rt(t),r=()=>{const v=(t.getAttribute("data-theme")||"").toLowerCase()==="dark";e.innerHTML=`
      .${e.id} {
    ...
    `},s=new MutationObserver(r);return s.observe(t,{attributes:!0,attributeFilter:["data-theme"]}),r(),Y(()=>{e.remove(),n.destroy(),s.disconnect()})}function Ee(t){const e=ae(t,{borderStyle:"hover",disableClicking:!0}),n=_(t);return n.innerHTML=`
    .${n.id} {
      display: flex;
      align-items: center;
  ...
  `,Y(()=>{e.destroy(),n.remove()})}function ot(t){const e=ae(t),n=_(t);n.innerHTML=`
    .${n.id} {
      user-select: none;
    }
  `;const r=document.createElement("div"),s=_(r);let v=t.getBoundingClientRect(),c="",f=!1;const b=k=>{c=t.style.getPropertyValue("transform"),t.style.setProperty("transform","none","important"),v=t.getBoundingClientRect(),t.style.setProperty("transform",c,"important"),k==null||k.preventDefault(),f=!0},m=[],y=()=>{t.style.setProperty("transform",c,"important");const k=getComputedStyle(t),I=k.getPropertyValue("--exio-standard-transition-duration"),ce=k.getPropertyValue("color"),z=k.getPropertyValue("background-color"),R=k.getPropertyValue("font-family"),De=k.getPropertyValue("font-size"),Se=k.getPropertyValue("padding"),$=k.getPropertyValue("padding-top"),Pe=k.getPropertyValue("padding-bottom");s.innerHTML=`
    ...
    `,r.innerHTML="",setTimeout(()=>{const de=t.querySelectorAll("option");let ne,B;de.forEach((ze,pe)=>{if(ze.disabled)return;const H=document.createElement("div");ne||(ne=H),B=H,H.style.padding=Se,H.style.boxSizing="border-box",H.style.cursor="default",H.textContent=ze.textContent,m.push(ae(H)),r.appendChild(H),H.addEventListener("click",()=>{t.selectedIndex=pe,t.dispatchEvent(new Event("change")),r.blur()})}),ne&&(ne.style.marginTop=$),B&&(B.style.marginBottom=Pe);const{height:Z,width:_e,left:ie}=r.getBoundingClientRect(),ue=Z+v.bottom>=window.innerHeight?Math.max(0,window.innerHeight-Z):v.bottom,C=_e+v.left>=window.innerWidth?Math.max(0,window.innerWidth-_e):ie;s.innerHTML+=`
      ...
      `},0)};y(),document.body.appendChild(r),t.addEventListener("mousedown",b),t.addEventListener("touchstart",b);const g=()=>{!f||(f=!1,y(),r.tabIndex=0,r.focus())};t.addEventListener("click",g),t.addEventListener("touchend",g);const h=()=>{r.blur()},x=()=>{r.tabIndex=-1};return r.addEventListener("blur",x),window.addEventListener("scroll",h),window.addEventListener("resize",h),Y(()=>{m.forEach(k=>k.destroy()),window.removeEventListener("scroll",h),window.removeEventListener("resize",h),t.removeEventListener("mousedown",b),t.removeEventListener("touchstart",b),t.removeEventListener("click",g),t.removeEventListener("touchend",g),r.removeEventListener("blur",x),e.destroy(),n.remove(),r.remove(),s.remove()})}const Vt=t=>{const e=ae(t,{borderStyle:"static"}),n=_(t);n.innerHTML=`
    .${n.id} {
  ...
  `,Y(()=>{e.destroy(),n.remove(),r.remove()})},jt=t=>{const e=ae(t,{borderStyle:"static"}),n=_(t);n.innerHTML=`
    .${n.id} {
      -webkit-appearance: none;
      width: 20px;
      height: 20px;
  ...
  `,Y(()=>{e.destroy(),n.remove(),r.remove()})};function Ut(t){let e=Boolean(t.open);const n=_(t);n.innerHTML=`
  ...
  `,Yt.registerDialog(t),t.close(),e&&t.showModal();const r=_(t);r.innerHTML=`
    .${r.id}:not([open]) {
      display: none;
    }
  `;const s=()=>{r.innerHTML=`
    ...
    `,v.style.opacity=e?"1":"0"};f(),t.parentElement.appendChild(v);const b=()=>m.observe(t,{attributes:!0,attributeFilter:["open"]}),m=new MutationObserver(()=>{e=Boolean(t.open),m.disconnect(),t.show(),t.close(),f(),e&&t.showModal(),b()});return b(),Y(()=>{n.remove(),t.removeEventListener("animationstart",s),r&&r.remove(),c.remove(),m.disconnect()})}function lt(t){const e=ae(t,{disableClicking:!0,borderStyle:"hover",focusable:!0}),n=_(t);return n.innerHTML=`
    .${n.id} {
  ...
  `,Y(()=>{e.destroy(),n.remove()})}function eo(t){const e=t.querySelector("summary"),n=ae(e,{borderStyle:"reactive"}),r=_(e);r.innerHTML=`
    .${r.id} {
      cursor: default;
      user-select: none;
      position: relative;
  ...
  `;const v=t.querySelector("*:not(summary)"),c=_(t),f=_(e);let b;const m=y=>{b&&clearTimeout(b);const g=getComputedStyle(e),h=()=>Nt(g.getPropertyValue("--exio-slow-transition-duration")),x=e.offsetHeight+v.offsetHeight;t.open?(y.preventDefault(),c.innerHTML=`
      ...
      `,setTimeout(()=>{c.innerHTML=`
        ...
        `,b=setTimeout(()=>{c.innerHTML=""},h())},0))};return e.addEventListener("click",m),Y(()=>{n.destroy(),r.remove(),s.remove(),c.remove(),e.removeEventListener("click",m)})}function nt(t){const e=_(t),n=`

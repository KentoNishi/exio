import{S as Ct,i as Ht,s as Tt,e as r,f as u,g as i,h as a,j as ve,k as o,l as p,p as Ie,o as he,r as Re,u as Ne,x as yt,n as ke,b as me,z as Mt}from"./vendor.4de8a817.js";import{g as Q,s as w,h as X,i as Et,t as St,j as Ye,b as qe,a as U,e as We,k as kt,f as wt,l as Pt,c as Ot,d as Dt}from"./consts.64612b0b.js";function we(t){const e=Q(t,{borderStyle:"hover",disableClicking:!0}),l=w(t);return l.innerHTML=`
    .${l.id} {
      display: flex;
      align-items: center;
  ...
  `;const s=()=>{n.innerHTML=`
    ...
    `,t.removeEventListener("animationstart",s)};t.addEventListener("animationstart",s);const v=document.createElement("div"),c=w(v),m=()=>{const k=getComputedStyle(t),y=k.getPropertyValue("--exio-slow-transition-duration"),g=k.getPropertyValue("--exio-backdrop-color");c.innerHTML=`
      .${c.id} {
        position: fixed;
        top: 0px;
        left: 0px;
    ...
    `,v.style.opacity=e?"1":"0"};m(),t.parentElement.appendChild(v);const h=()=>f.observe(t,{attributes:!0,attributeFilter:["open"]}),f=new MutationObserver(()=>{e=Boolean(t.open),f.disconnect(),t.show(),t.close(),m(),e&&t.showModal(),h()});return h(),X(()=>{l.remove(),t.removeEventListener("animationstart",s),n&&n.remove(),c.remove(),f.disconnect()})}function $t(t){const e=Q(t,{disableClicking:!0,borderStyle:"hover",focusable:!0}),l=w(t);return l.innerHTML=`
    .${l.id} {
  ...
  `;const v=t.querySelector("*:not(summary)"),c=w(t),m=w(e);let h;const f=k=>{h&&clearTimeout(h);const y=getComputedStyle(e),g=()=>St(y.getPropertyValue("--exio-slow-transition-duration")),b=e.offsetHeight+v.offsetHeight;t.open?(k.preventDefault(),c.innerHTML=`
        .${c.id} {
          max-height: ${b}px;
        }
      ...
      `,setTimeout(()=>{c.innerHTML=`
        ...
        `,h=setTimeout(()=>{c.innerHTML=""},g())},0))};return e.addEventListener("click",f),X(()=>{l.destroy(),n.remove(),s.remove(),c.remove(),e.removeEventListener("click",f)})}function Xe(t){const e=w(t),l=`
